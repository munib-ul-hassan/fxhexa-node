...
//     const profitLoss =
//       Number(currentOpen).toFixed(4) - Number(item.openAmount)?.toFixed(4);
...
//     // new work
//     //   if (item.stock) {
//     //     url = `https://fcsapi.com/api-v3/stock/latest?id=${item.stock}&access_key=${process.env.fcsapikey} `;
//     //   } else {
...
//                 { fullName: "admin" },
//                 {
//                   $inc: { balance: Number(Number(item.unit / 0.01) * 0.1) },
//                 }
//               );

//               await AuthModel.findOneAndUpdate(
//                 {
//                   _id: item.accountref.auth.referBy,
//                   "referer.user": item.accountref.auth._id,
//                 },
//                 {
//                   $inc: {
//                     "referer.$.amount": Number(Number(item.unit / 0.01) * 0.05),
//                   },
//                 }
//               );
//             } else {
